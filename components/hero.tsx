      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div className="space-y-4">
            <p className="text-sm text-neutral-600 dark:text-neutral-400">Halo, saya</p>
            ...
            <p className="max-w-2xl text-neutral-700 dark:text-neutral-300">
              Frontend-focused Developer dengan pengalaman 4+ tahun, awalnya fokus di backend menggunakan Laravel. Saat ini menspesialisasikan diri di React.js untuk membangun antarmuka yang responsif dan integrasi API yang efektif.
            </p>
          </div>
