...
const allProjects = [
  {
    ...
    description:
      "Platform layanan informasi publik untuk mendukung transparansi pemerintahan.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Sistem manajemen sekolah untuk penempatan siswa dan administrasi akademik.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Layanan REST API untuk mendukung aplikasi administratif pemerintahan.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Layanan REST API untuk sistem manajemen antrian pelayanan publik.",
    highlights: [
